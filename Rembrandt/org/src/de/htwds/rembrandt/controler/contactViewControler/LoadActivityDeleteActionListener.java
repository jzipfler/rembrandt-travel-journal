...
public class LoadActivityDeleteActionListener implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
			...
			//System.out.println(FolderPathController.getActivitiesFolder(viewActivity.getParentFrame().getJourneyModel().getGeneralInformationModel().getFolderName()) + " >>" +viewActivity.get_Description() + "_" + viewActivity.get_Time());
